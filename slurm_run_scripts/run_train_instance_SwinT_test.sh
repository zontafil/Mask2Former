...
#SBATCH --output=../csc-run-logs/Train_SwinT_instance_15min.txt
...
srun python3 ../train_net.py --num-gpus 2 --num-machines 1 --config-file configs/coco/instance-segmentation/swin/maskformer2_swin_tiny_bs16_50ep.yaml MODEL.WEIGHTS checkpoints/swin_tiny_patch4_window7_224.pkl

# Resume training. Resume does not need weight spcified, instead it used weights specified: ./experiments/SwinT/last_checkpoint
#srun python3 ../train_net.py --num-gpus 2 --num-machines 1 --config-file configs/coco/instance-segmentation/swin/maskformer2_swin_tiny_bs16_50ep.yaml --resume