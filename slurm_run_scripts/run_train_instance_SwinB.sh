...
#SBATCH --output=../csc-run-logs/Train_SwinB_instance_new_augs_part2_test.txt
...
srun python3 ../train_net.py --num-gpus 4 --num-machines 2 --config-file configs/coco/instance-segmentation/swin/maskformer2_swin_base_IN21k_384_bs16_50ep.yaml --resume